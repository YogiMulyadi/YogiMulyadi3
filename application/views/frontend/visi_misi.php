		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				<ul class="menu_list menu_mm">
                    <li class="main_nav_item"><a href="<?= base_url('index.php/views/index');?>">Home</a></li>
                    <li class="main_nav_item"><a href="<?= base_url('index.php/views/profile'); ?>">Profil </a></li>
                    <li class="main_nav_item"><a href="courses.html">Data Siswa</a></li>
                    <li class="main_nav_item"><a href="elements.html">Artikel</a></li>
                    <li class="main_nav_item"><a href="news.html">Jurusan</a></li>
                    <li class="main_nav_item"><a href="contact.html">Kontak</a></li>
                    ...
                    <div class="news_post_top d-flex flex-column flex-sm-row">
                        <div class="news_post_title_container">
                            <div class="news_post_title">
                                <a class="text-dark">Visi Misi SMKN 2 Bandung</a>
                            </div>
                        </div>
                    </div>
                    <div class="news_post_quote" >
                        <p class="news_post_quote_text"><span>Visi</span>
                            Sebagai lembaga pendidikan kejuruan profesional dan 
                            berwawasan lingkungan yang mampu menghasilkan lulusan 
                            yang bertaqwa, cerdas, kompeten dan kompetitif.
                        </p>
                    </div>
                    <div class="news_post_quote">
                        <p class="news_post_quote_text"><span>Misi</span>
                            Menyiapkan dan melatih siswa sehingga lulusan mampu:
                            Mengembangkan sikap kewirausahaan yang jujur dan bertanggung jawab.
                            Memberikan mutu layanan pendidikan kejuruan yang profesional dan berkualitas.
                            Meningkatkan kebekerjaan lulusan serta dapat mengembangkan sikap profesional sesuai bidang keahliannya.
                            Menghasilkan lulusan yang mampu memilih karir, berkompeten, produktif dan dapat mengembangkan diri.
                            Menciptakan lingkungan sekolah yang kondusif.
                            Menjalin kerjasama dengan dunia usaha/dunia industri serta instansi terkait.
                        </p>
                    </div>
                    <br><br>
					<!-- Page Nav -->
