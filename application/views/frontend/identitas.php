					...
					<div class="news_posts">
                        <div class="card">
                            <h1 class="card-header">
                                <center class="text-dark">Indentitas SMK Negeri 2 Bandung</center></h1> <br>
                                <div class="text-dark">
                                    <div class="card-body">
                                        <div class="container">
                                            <div class="row">
                                                <h3 class="col" >Nama Sekolah</h3>
                                                <h3 class="col">: SMK Negeri 2 Bandung</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >NSS</h3>
                                                <h3 class="col">: 32.10.26007006</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >NPSN</h3>
                                                <h3 class="col">: 20.219.146</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >ID Ujian Nasional</h3>
                                                <h3 class="col">: 102.21</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Jenjang Pendidikan</h3>
                                                <h3 class="col">: SMK</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Status Sekolah</h3>
                                                <h3 class="col">: Negeri</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >No. SK Pendirian/TMT/Tanggal SK</h3>
                                                <h3 class="col">: 3835/B.II/1951 TMT : 01/08/1951 Tgl : 30-08-1951</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Penanda Tangan SK</h3>
                                                <h3 class="col">: Menteri Pendidikan, Pengadjaran Dan Kebudayaan RI</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >PBM</h3>
                                                <h3 class="col">: Pagi</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Sertifikat</h3>
                                                <h3 class="col">: Sertifikat Akreditasi ‘A’ BAS Provinsi Tahun 2012</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Alamat Sekolah</h3>
                                                <h3 class="col">: Jl. Ciliwung No.4 RT.02 RW.03, Bandung 40114</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Posisi Geografis</h3>
                                                <h3 class="col">: Lintang  -6,9059  Bujur : 107,6236</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Telepon/Fax</h3>
                                                <h3 class="col">: (022) 7234285, 4231857</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Kepala Sekolah</h3>
                                                <h3 class="col">: Drs. TATANG GUNAWAN, M.M.Pd</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >NIP</h3>
                                                <h3 class="col">: 19630327 198803 1 008</h3>
                                                    <h3 class="w-100"></h3>
                                                <h3 class="col" >Email / Website</h3>
                                                <h3 class="col">: humas@smkn2bandung.sch.id</h3>
                                            </div>
                                        </div>
                                    </div>   
                                </div>
