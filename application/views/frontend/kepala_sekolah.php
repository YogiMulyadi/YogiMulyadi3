                        ...
                        <div class="news_post_title_container">
                                <div class="news_post_title">
                                    <div class="text-center">
                                        <a class="text-dark ">KEPALA SEKOLAH</a>
                                    </div>
                                <br>
                            </div>
                        </div>
                            <div class="news_post_image">
                                <img src="<?=base_url('assets/')?>images/kepsek.jpg" alt="https://unsplash.com/@dsmacinnes"/>
                                <h3 class="text-dark">Drs. TATANG GUNAWAN, M.M.Pd</h3>
                            </div>
                        </div>
                        <div class="news_post_text">
                            <h3>
                                <p class="text-dark">
                                    Selamat datang di dunia pendidikan SMKN 2 Bandung. 
                                    Kami merasa sangat bangga mendapatkan perhatian dan kepercayaan dari 
                                    Bapak-Ibu sekalian. Kami akan berupaya untuk dapat menjalankan amanah 
                                    ini dengan baik agar pertanggung jawaban di hadapan Allah SWT kelak menjadi ringan.
                                    Di sini kami mengajak anda para orang tua siswa untuk berpartisipasi membangun 
                                    masyarakat pembelajar dalam rangka menyongsong era baru bagi anak-anak kita dan 
                                    menjadikan anak-anak kita generasi yang mampu berkompetisi tanpa kehilangan 
                                    wajah budaya dan moral. 
                                </p>
                            </h3>
                        </div>
                        <div class="news_post_quote">
                            <h3>
                                <p class="news_post_quote_text">
                                    <span>M</span>emasuki pergaulan global yang penuh dengan kompetisi ini, 
                                    kita perlu menyiapkan mental anak-anak kita agar mampu bersaing dengan 
                                    baik dengan memiliki moral/adab islami, kemandirian, kecerdasan, 
                                    juga tentunya kreatifitas-inovasi sesuai tumbuh kembangnya.
                                </p>
                            </h3>
                        </div>
                        <div class="news_post_text">
                            <h3>
                                <p class="text-dark" >
                                    Di SMKN 2 Bandung setiap siswa memiliki hak untuk berprestasi dan 
                                    mendapatkan pelayanan yang baik. Karena kami memandang ini semua adalah amanah yang 
                                    akan kami pertanggung jawabkan di hadapan Allah SWT. Tentu hal ini semakin terasa 
                                    mudah dengan adanya kerjasama dari para orang tua siswa dalam menjalankan program sekolah.
                                    Sebagai penutup, sekali lagi kami ucapkan selamat datang di SMKN 2 Bandung.
                                    Marilah bekerjasama agar anak-anak kita dapat berkembang dengan baik sehingga
                                    tumbuh menjadi generasi yang berakhlakul karimah dan cerdas.
                                </p>
                            </h3>
                    </div>
                    <br><br>
