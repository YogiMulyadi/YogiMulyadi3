				...
				<div class="col-lg-8">
					<div class="news_posts">
						<div class="news_post_title">
							<a class="text-dark"><h1>Kerjasama Pembelajaran SMKN 2 Bandung</h1></a>
						</div>
						<div class="hero_slide_content text-center" >
							<img src="<?=base_url('assets/')?>images/aws.jpg" alt="https://unsplash.com/@dsmacinnes"/>
							<br><br>
							<h2 class="text-center">
								<b class="text-dark">
								PT. Asian Welding Specialist (AWS)
								</b>
							</h2>
						</div>
						</div>
						<div class="hero_slide_content text-center" >
							<img src="<?=base_url('assets/')?>images/angkasa.jpg" alt="https://unsplash.com/@dsmacinnes"/>
							<br><br>
							<h2 class="text-center">
								<b class="text-dark">
						...
						<div class="hero_slide_content text-center" >
							<img src="<?=base_url('assets/')?>images/komatsu.jpeg" alt="https://unsplash.com/@dsmacinnes"/>
							<br><br>
							<h2 class="text-center">
								<b class="text-dark">
						...
						<div class="hero_slide_content text-center" >
							<img src="<?=base_url('assets/')?>images/jia.jpg"  alt="https://unsplash.com/@dsmacinnes"/>
							<br><br>
							<h2 class="text-center">
								<b class="text-dark">
								PT. JIAEC
						...
						<div class="hero_slide_content text-center" >
							<img src="<?=base_url('assets/')?>images/cor.jpg"  alt="https://unsplash.com/@dsmacinnes"/>
							<br><br>
							<h2 class="text-center">
								<b class="text-dark">
								Corporate locations
