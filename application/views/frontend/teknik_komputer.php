				...
				<div class="col-lg-8">
					<div class="news_posts">
                        <div class="news_post_image">
                                <img src="<?=base_url('assets/')?>images/Komp.jpg" alt="https://unsplash.com/@dsmacinnes"/>
                            </div>
                            <div class="news_post_title_container">
                                <div class="news_post_title"><br>
                                <a class="text-dark"><h1>Kompetensi Keahlian Teknik Komputer dan Inpormatika</h1></a>
                                </div>
                            </div>
                            <div class="news_post_quote">
                                <p class="news_post_quote_text"><span>R</span>ekayasa Perangkat Lunak (RPL)</p>
                            </div>
                            <p class="news_post_text">
                                <p class="text-dark">1. Menguasai Teknik Elektronika Analog dan digital Dasar</p>
                                <p class="text-dark">2. Menguasai Algoritma Pemrograman</p>
                                <p class="text-dark">3. Menguasai pembuatan WEB statis</p>
                                <p class="text-dark">4. Menguasai aplikasi basis data</p>
                                <p class="text-dark">5. Menguasai perancangan basis data</p>
                                <p class="text-dark">6. Menguasai pemrograman visual berbasis desktop</p>
                                <p class="text-dark">7. Mengoperasikan sistem operasi jaringan komputer</p>
                                <p class="text-dark">8. Menguasai bahasa pemrograman visual berbasis desktop</p>
                                <p class="text-dark">9. Membuat halaman web dinamis</p>
                                <p class="text-dark">10.Membuat program aplikasi web berbasis object oriented (OOP)</p>
                                <p class="text-dark">11.Membuat program aplikasi teks dan desktop berbahasa OOP</p>
                                <p class="text-dark">12.Membuat aplikasi program basis data menggunakan SQL</p>
                                <p class="text-dark">13.Mengintegrasikan basis data dengan sebuah web</p>
                                <p class="text-dark">14.Membuat program basis data menggunakan SQL</p>
                                <p class="text-dark">15.Membuat program aplikasi web berbasis JSP</p>
                                <p class="text-dark">16.Membuat program basis data berbasis XML</p></p>
                            <div class="news_post_quote">
                                <p class="news_post_quote_text"><span>M</span>ultimedia (MM)</p>
                            </div>
                            <div class="news_post_text">
                                    <p class="text-dark">1. Menginstalasi sistim operasi</p>
                                    <p class="text-dark">2. Menyusun penawaran proposal proyek multimedia</p>
                                    <p class="text-dark">3. Membuat animasi stop-motion (bidang datar)</p>
                                    <p class="text-dark">4. Menerapkan efek khusus pada objek produksi</p>
                                    <p class="text-dark">5. Menerapkan prinsip-prinsip seni fotografi dalam desain 
                                                            komunikasi visual untuk multimedia</p>
                                    <p class="text-dark">6. Merawat peralatan shooting</p>
                                    <p class="text-dark">7. Memperbarui isi halaman WEB</p>
                                    <p class="text-dark">8. Menguasai teknik pengambilan gambar produksi</p>
                                    <p class="text-dark">9. Menerapkan prinsip-prinsip seni grafis dalam desain komunikasi 
                                                            visual untuk multimedia</p>                                                                                                
                            </div>
                            <div class="news_post_quote">
                                    <p class="news_post_quote_text"><span>T</span>EKNIK KOMPUTER DAN JARINGAN (TKJ)</p>
                                </div>
                            <div class="news_post_text">
                                <p class="text-dark">1. Melihat perkembangan teknologi informasi dan komunikasi saat ini tidak 
                                                        dapat dipungkiri lagi bahwa sudah menjadi kebutuhan hidup sehari-hari 
                                                        bagi setiap orang yang dimana pekerjaannya sebagian besar menggunakan teknologi 
                                                        informasi misalnya Komputer, Handphone, IPOD dan lain sebagainya;</p>     
                                <p class="text-dark">2. Transaksi bisnis saat ini rata-rata sudah bergantung kepada mesin-mesin yang 
                                                        bekerja selama 24 jam misalnya perusahaan-perusahaan Hosting, Bank, perusahaan 
                                                        yang bergerak dibidang Komunikasi sekalipun;</p>     
                                    
                                <p class="text-dark">3. Setiap hari, setiap bulan dan tahun teknologi informasi berkembang tiada henti 
                                                        seiring dengan perkembangan jaman khususnya dijaman digitalisasi seperti sekarang ini;</p>     
                                    
                                <p class="text-dark">4. Peluang kerja di era kedepan sudah dipastikan manusia dapat berinteraksi 
                                                        dengan mesin-mesin yang bekerja secara kontinyu, dimana manusia beperan sebagai
                                                        kontrol terhadap mesin-mesin tersebut;</p>     
                                    
                                <p class="text-dark">5. Dalam kehidupan sehari-hari manusia sudah sangat bergantung kepada 
                                                        pemanfaatan teknologi informasi dan komunikasi baik itu dibigan usaha, ekonomi, 
                                                        perbankan, perindustiran, bahkan saat ini sudah mermbah kebidang pendidikan dan 
                                                        lain sebagainya.</p>                                                                                              
                            </div>
                        </div>
					<!-- Page Nav -->
