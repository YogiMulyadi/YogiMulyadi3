					...
					<div class="news_posts">
                        <div class="news_post_image">
                            ...
                            <div class="news_post_title_container">
                                ...
                                <a class="text-dark"><h1>Kompetensi Keahlian Teknik Mesin</h1></a>
                                </div>
                            </div>
                            <div class="news_post_quote" >
                                <p class="news_post_quote_text"><span>K</span>ompetensi Teknik Permesinan</p>
                            </div>
                            <p class="news_post_text" >
                                <p class="text-dark">1. Melaksanakan penangan material secara manual</p>
                                <p class="text-dark">2. Menggunakan peralatan pembandingan dan/atau alat ukur dasar</p>
                                <p class="text-dark">3. Mengukur dengan alat ukur mekanik presisi</p>
                                <p class="text-dark">4. Menggunakan perkakas tangan</p>
                                <p class="text-dark">5. Menggunakan perkakas bertenaga/operasi digenggam</p>
                                <p class="text-dark">6. Menginterprestasikan sketsa</p>
                                <p class="text-dark">7. Membaca gambar sketsa</p>
                                <p class="text-dark">8. Membaca gambar teknik</p>
                                <p class="text-dark">9. Menggunakan mesin untuk operasi dasar</p>
                                <p class="text-dark">10. Melakukan pekerjaan dengan mesin bubut</p>
                                <p class="text-dark">11. Melakukan pekerjaan dengan mesin frais</p>
                                <p class="text-dark">12. Melakukan pekerjaan dengan mesin gerinda</p>
                                <p class="text-dark">13. Menggunakan mesin bubut (kompleks)</p>
                                <p class="text-dark">14. Memfrais (kompleks)</p>
                                <p class="text-dark">15. Menggerinda pahat dan alat potong</p>
                                <p class="text-dark">16. Mengeset mesin dan program mesin NC/CNC (dasar)</p>
                                <p class="text-dark">17. Memprogram mesin NC/CNC (dasar)</p>
                                <p class="text-dark">18. Mengoperasikan mesin NC/CNC (dasar)</p>
                            </p>
                            <div class="news_post_quote">
                                <p class="news_post_quote_text"><span>K</span>ompetensi Teknik Gambar Mesin</p>
                            </div>
                            <p class="news_post_text" >
                                <p class="text-dark">1. Memindah material secara manual</p>
                                <p class="text-dark">2. Menggunakan peralatan perbandingan dan / atau alat ukur dasar</p>
                                <p class="text-dark">3. Mengukur dengan alat ukur mekanik presisi</p>
                                <p class="text-dark">4. Menggunakan perkakas tangan</p>
                                <p class="text-dark">5. Menggunakan perkakas bertenaga/operasi digenggam</p>
                                <p class="text-dark">6. Menggunakan mesin untuk operasi dasar</p>
                                <p class="text-dark">7. Melakukan rutinitas las oksigen-asetilen (las karbit)</p>
                                <p class="text-dark">8. Melakukan rutinitas pengelasan menggunakan las busur manual dan/atau las gas (metal)</p>
                                <p class="text-dark">9. Melaksanakan fabrikasi, pembentukan, pelengkungan, dan pencetakan</p>
                                <p class="text-dark">10.Menginterpretasikan sketsa</p>
                                <p class="text-dark">11.Membaca gambar teknik</p>
                                <p class="text-dark">12.Mempersiapkan gambar teknik dasar</p>
                                <p class="text-dark">13.Merancang gambar teknik secara rinci</p>
                                <p class="text-dark">14.Membuat bukaan/bentangan geometri lanjut benda silinder / persegi panjang</p>
                                <p class="text-dark">15.Menggambar bukaan/bentangan geometri lanjut benda kerucut /kronis</p>
                                <p class="text-dark">16.Menggambar bukaan/bentangan geometri lanjut benda transisi</p>
                                <p class="text-dark">17.menggambar 2D dengan sistem CAD</p>
                                <p class="text-dark">18.membuat model 3D dengan sistem CAD</p>
                            </p>
                        </div>
					<!-- Page Nav -->
